  ...
  <div class="content-wrapper">
    ...
    <div class="row">
         @if($setting->maintenance =='AKTIF')
                <div class="px-2 bg-danger mb-3"><marquee class="py-3 text-white">Mohon maaf, saat ini sistem sedang Maintenance/Perbaikan - Beberapa fitur mungkin tidak dapat digunakan!</marquee></div>
              @endif
          ...
          <div class="card-list-group">
            @foreach ($jadwal as $j => $event)
              <div class="list-group-item list-group-item" aria-current="true" style="margin-bottom: 10px">
                ...
                @endif
                @if ($waktu->toTimeString() >$event->selesai)
